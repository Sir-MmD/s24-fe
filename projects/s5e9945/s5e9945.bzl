...
load(":s5e9945_model_variant_modules.bzl", "MODEL_VARIANT_MODULE_LIST", "MODEL_VARIANT_DLKM_MODULE_LIST")
load(
    ":s5e9945_modules.bzl",
...
def define_s5e9945_kernel(
    ...
    _exynos_vendor_dlkm_list = VENDOR_DLKM_MODULE_LIST + MODEL_VARIANT_DLKM_MODULE_LIST
    _all_exynos_module_list = VENDOR_EARLY_MODULE_LIST + _exynos_vendor_boot_list + _exynos_vendor_dlkm_list
    ...
    extract_modules(
        ...
        target_dir = "vendor",
        kernel_build = name,
        module_list = _exynos_vendor_dlkm_list,
    )
