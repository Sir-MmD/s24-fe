...
# BSP Property for Netflix AV1
PRODUCT_PROPERTY_OVERRIDES += ro.netflix.bsp_rev=EXYNOS2400-37698-1
...
ifneq ($(filter e1s% e2s% e3s% r12s% b7r% r13s%, $(TARGET_PRODUCT)),)
PRODUCT_COPY_FILES += \
...
ifneq ($(filter r13s%, $(TARGET_PRODUCT)),)
$(call inherit-product, device/samsung/erd9945/scsc_wlbt.mk)
